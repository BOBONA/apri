...
public class OutlineRenderer implements Disposable {
    ...
    public OutlineRenderer(boolean drawBodies, boolean drawJoints, boolean drawAABBs, boolean drawInactiveBodies,
    ...
    public void render (World world, Matrix4 projMatrix) {
        ...
        renderBodies(world, bodies);
    }

    public void renderSpecific (World world, Matrix4 projMatrix, Array<Body> bodies) {
        renderer.setProjectionMatrix(projMatrix);
        renderBodies(world, bodies);
    }
    ...
    private void renderBodies (World world, Array<Body> bodies) {
    ...
    protected void renderBody (Body body) {
        ...
        for (Fixture fixture : body.getFixtureList()) {
            if (drawBodies && !fixture.isSensor()) {
